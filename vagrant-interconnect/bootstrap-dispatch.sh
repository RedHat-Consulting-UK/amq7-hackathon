...
# Install QPid, current version is: 0.7
...
which qdrouterd &&
    ls -lrt /usr/share/proton-0.17.0/examples/python &&
...
# python /usr/share/proton-0.17.0/examples/python/simple_recv.py -a /jms.queue.first -m 1
# python /usr/share/proton-0.17.0/examples/python/simple_send.py -a /jms.queue.first -m 1
